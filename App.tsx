      ...
      return (
        <div className="pt-32 pb-20 min-h-screen bg-rosy-black flex items-center justify-center px-4">
          <div className="bg-rosy-dark/50 p-8 rounded-lg text-center max-w-md w-full border border-rosy-red/30">
            ...
            <p className="text-gray-300 mb-6">Obrigado por comprar na Rosy Modas. Você receberá um e-mail com os detalhes do rastreamento.</p>
              ...
              <form onSubmit={finalizeOrder} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input required type="text" className="w-full bg-rosy-dark border border-gray-600 rounded p-2 text-white focus:border-rosy-red outline-none" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input required type="email" className="w-full bg-rosy-dark border border-gray-600 rounded p-2 text-white focus:border-rosy-red outline-none" />
                </div>
                
                <div className="pt-6">
                   <button type="submit" className="w-full bg-rosy-red hover:bg-red-700 text-white font-bold py-3 rounded transition-colors">
                     Pagar e Finalizar
                   </button>
                </div>
              </form>
